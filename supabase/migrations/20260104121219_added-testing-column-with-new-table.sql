  ...
  create table "mod_base"."TestingColumn" (
    "id" bigint generated by default as identity not null,
    "created_at" timestamp with time zone not null default now()
      );


alter table "mod_base"."TestingColumn" enable row level security;

alter table "mod_base"."article_categories" add column "testing" text;

CREATE UNIQUE INDEX "TestingColumn_pkey" ON mod_base."TestingColumn" USING btree (id);

alter table "mod_base"."TestingColumn" add constraint "TestingColumn_pkey" PRIMARY KEY using index "TestingColumn_pkey";
